...
def load_arguments(self, _):
    ...
    for scope in ['cosmosdb create', 'cosmosdb update']:
        with self.argument_context(scope) as c:
            ...
            c.argument('network_acl_bypass', options_list=['--network-acl-bypass', '--bypass'], help="Flag to enable or disable Network Acl Bypass.")
            c.argument('network_acl_bypass_resource_ids', options_list=['--network-acl-bypass-resource-ids'], help="List of Resource Ids to allow Network Acl Bypass.")
