...
def load_arguments(self, _):
    ...
    for scope in ['cosmosdb create', 'cosmosdb update']:
        with self.argument_context(scope) as c:
            ...
            c.argument('network_acl_bypass', options_list=['--network-acl-bypass'], arg_type=get_three_state_flag(), help="Flag to enable or disable Network Acl Bypass.")
            c.argument('network_acl_bypass_resource_ids', options_list=['--network-acl-bypass-resource-ids'], arg_type=get_three_state_flag(), help="List of Resource Ids to allow Network Acl Bypass.")
